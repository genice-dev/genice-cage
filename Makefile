...
test: 1h.cage.gro.test 1h.cage.yap.test CS1.cage.test CS2.cage.json.test CRN1.cage.json.test 
...
1h.cage.gro: $(PKGNAME)/formats/cage.py Makefile
	genice 1h -r 2 2 2 -f cage[-5:maxring=6:gromacs] > $@
%.test:
	make $*
	diff $* ref/$*
